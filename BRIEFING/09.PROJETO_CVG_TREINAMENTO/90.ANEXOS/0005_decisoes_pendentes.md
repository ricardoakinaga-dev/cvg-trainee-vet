...
**Atualização 2026-08-05 (validação documental):** D-040 a D-044 sincronizados com as decisões do patrocinador (ver anexo 0009); incluídas D-067 (licença do Fossum — F-03), D-068 (modalidade da primeira versão), D-069 (conformidade estrita dos gates), D-070 (avaliação de respostas construídas), D-071 (modelo de governança mínima segregada), D-072 (coordenação geral interina das correções), D-073 (rascunho conservador de dados/LGPD) e D-074 (separação entre conteúdo autoral visível e rastreabilidade interna das fontes).
...
| ID | Pergunta/decisão | Owner | Bloqueia | Status |
|---|---|---|---|---|
| D-030 | Há licença para uso institucional do tratado? | jurídico | conteúdo | pendente — D-074 define consulta e validação internas, mas não comprova a legitimidade da cópia nem o direito de consulta institucional |
| D-031 | Há licença para uso institucional do Ettinger? | jurídico | conteúdo | pendente — D-074 define consulta e validação internas, mas não comprova a legitimidade da cópia nem o direito de consulta institucional |
| D-032 | É permitido criar material derivado? | jurídico | conteúdo | pendente — D-074 exige redação institucional independente e proíbe reprodução, tradução, adaptação ou paráfrase próxima; a validação jurídica continua obrigatória |
| D-033 | Os PDFs podem ser processados por ferramentas automatizadas? | jurídico/segurança | SPEC/conteúdo | pendente — processamento automatizado permanece bloqueado por D-074 até autorização formal |
...
| D-067 | Há licença para uso institucional do Fossum (cirurgia)? | jurídico | conteúdo | pendente (B-04) — D-074 define consulta e validação internas, mas não comprova a legitimidade da cópia nem o direito de consulta institucional |
...
| D-074 | Como usar as obras como consulta/validação técnica sem expor referências ao aluno? | patrocinador/jurídico/comitê | plano de correção/B-04 | aprovada como diretriz de workflow (2026-08-05): Alternativa 1, conteúdo autoral CVG sem nomes das obras na interface e rastreabilidade completa interna; B-04 permanece parcial até verificação jurídica |
