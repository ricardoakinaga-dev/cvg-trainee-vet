...
**Status:** problema delimitado para validação
...
O problema será mensurado pelas seguintes dimensões:

- Percentual de veterinários com diagnóstico inicial;
- Percentual com trilha atribuída;
- Progresso e conclusão;
- Domínio por tema e competência;
- Ganho entre pré e pós-avaliação;
- Retenção após intervalo;
- Número de tentativas e recuperação;
- Atraso e abandono;
- Qualidade das questões;
- Atualidade e rastreabilidade do conteúdo;
- Cobertura de revisão clínica.

As metas numéricas definitivas dependerão de uma linha de base.
...
- Governança de conteúdo e avaliações;
- Rastreabilidade até a fonte;
- Reforço e remediação;
- Definição de critérios de progressão.

## O que não será resolvido nesta etapa
...
- Diagnóstico causal de desfechos clínicos;
...
- Quem tomará decisões a partir das métricas.
