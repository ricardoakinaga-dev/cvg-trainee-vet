...
10. PDFs-fonte, fotos, OCR, cópias protegidas e envio desses ativos a IA fora do produto; Qdrant/embeddings podem existir somente para registros autorais internos autorizados, sem exposição ao participante;
...
14. Microsserviços de domínio, mensageria distribuída, data warehouse e BI externo sem evidência de necessidade; Qdrant interno é a exceção especificada para busca semântica de autoria.
