...
| RN-026 | Tentativas da prova somativa: 2 + remediação obrigatória | APROVADA (gate 2026-08-05) |
| RN-027 | Intervalo mínimo entre tentativas: 7 dias | APROVADA (gate 2026-08-05) |
| RN-028 | Após reprovação, remediação é obrigatória antes de nova tentativa | APROVADA (gate 2026-08-05) |
| RN-029 | Itens usados na segunda tentativa são diferentes da primeira | APROVADA (gate 2026-08-05) |
| RN-030 | Avaliação de retenção usa itens equivalentes, não repetição literal | APROVADA (gate 2026-08-05) |
...
| RN-041 | Hierarquia de fontes: legislação/bula > protocolo CVG > diretriz atual > Ettinger 2024 > Fossum 2014 (temas cirúrgicos) > Tratado 2015 | APROVADA (gate 2026-08-05 — atualizada 2026-08-05: inclusão do Fossum, F-03) |
...
| RN-046 | Uso das obras no piloto: sínteses autorais curtas com citação (fonte, capítulo, páginas); PDFs não publicados; cada item marcado como "direitos verificados" no workflow editorial; verificação jurídica em andamento (B-04) | APROVADA (gate 2026-08-05) |
| RN-047 | Validade por tipo de conteúdo: crítico 6 meses, clínico geral 12, fundamentos 24; alerta = revisão imediata | APROVADA (gate 2026-08-05) |
| RN-048 | Retirada emergencial: crítico até 24h, alto até 3 dias úteis; registra afetados e ação corretiva | APROVADA (gate 2026-08-05) |
| RN-049 | Conteúdo vencido não é exibido como ativo | APROVADA (gate 2026-08-05) |

## 5. Regras de integridade e auditoria

| ID | Regra | Classificação |
|---|---|---|
| RN-050 | Banco de questões maior que a prova; seleção aleatória e embaralhamento (banco ≥ 1,5× os itens aplicados por tentativa) | APROVADA (gate 2026-08-05) |
...
| RN-053 | Contestação gera protocolo; revisor independente avalia; anulação recalcula afetados; prazo de resposta: 7 dias úteis | APROVADA (gate 2026-08-05) |
| RN-054 | Compartilhamento de questões é violação; termo de uso registra proibição | APROVADA (gate 2026-08-05) |
| RN-055 | Detecção de padrões anômalos nunca gera penalidade automática; exige revisão humana | APROVADA (gate 2026-08-05) |
...
| RN-063 | Colaborador vê os dados utilizados sobre si | APROVADA (gate 2026-08-05) |
| RN-064 | Acesso restrito ao mínimo necessário: colaborador (próprio); mentor (lacunas dos mentorados); gestor educacional (agregado + individual autorizado); gestão de pessoas (somente status de conclusão); direção (agregado) | APROVADA (gate 2026-08-05) |
| RN-065 | Retenção dos dados: enquanto durar o vínculo + 2 anos; descarte auditável; ajustes conforme jurídico/LGPD | APROVADA (gate 2026-08-05) |
| RN-066 | Uso de resultados em RH: proibido no piloto; qualquer uso futuro exige política formal aprovada | APROVADA (gate 2026-08-05) |
| RN-067 | Correção manual de nota exige fluxo formal: justificativa + aprovação + versão + auditoria | APROVADA (gate 2026-08-05) |
