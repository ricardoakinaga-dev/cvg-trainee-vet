...
export function createDigitalCaseDefinition(
  ...
  const examSeries: readonly DigitalCaseExamSeries[] = freeze([
    freeze({
      ...
      observations: freeze([
        ...
        freeze({
          ...
          syntheticSummary:
            "Achado sintético de reavaliação do cenário digital.",
        }),
      ]),
    }),
    freeze({
  ...
  const branches: readonly DigitalCaseBranch[] = freeze([
    freeze({
      id: "S1-A",
      fromStage: 1,
    ...
    freeze({
      ...
      consequence:
        "Ramo simulado de reavaliação; o traçado seriado é liberado.",
