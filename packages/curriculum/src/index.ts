...
export type {
  AdvanceDigitalCaseInput,
  CaseExamModality,
  CaseStage,
  CaseStateValue,
  DigitalCaseBranch,
  DigitalCaseConsequence,
  DigitalCaseCurrentStage,
  DigitalCaseDefinition,
  DigitalCaseExamObservation,
  DigitalCaseExamSeries,
  DigitalCaseRuntimeState,
  PublicDigitalCaseRuntimeState,
  DigitalCaseStatePatch,
  DoseInfusionInputs,
  DoseInfusionResponseSpec,
...
export type {
  ...
  TransferMetric,
  SpacedReviewDay,
  CurriculumDigitalCaseDefinition,
  CurriculumStructuredValue,
} from "./types.js";
