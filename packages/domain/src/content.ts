...
export type ContentEvent =
  ...
  | { readonly type: "INICIAR_REVISAO_CLINICA" }
  | { readonly type: "SOLICITAR_AJUSTES" }
  | { readonly type: "RETORNAR_A_RASCUNHO" }
...
const transitions: Readonly<
  ...
  >
> = {
  RASCUNHO: { AUTOVERIFICAR: "AUTOVERIFICADO" },
  AUTOVERIFICADO: { INICIAR_REVISAO_CLINICA: "EM_REVISAO_CLINICA" },
  EM_REVISAO_CLINICA: {
    SOLICITAR_AJUSTES: "AJUSTES_SOLICITADOS",
    APROVAR_CLINICAMENTE: "APROVADO_CLINICAMENTE",
  },
  AJUSTES_SOLICITADOS: { RETORNAR_A_RASCUNHO: "RASCUNHO" },
  APROVADO_CLINICAMENTE: { VERIFICAR_PROJECAO: "PROJECAO_VERIFICADA" },
  PROJECAO_VERIFICADA: {
    AUTORIZAR_PUBLICACAO: "AUTORIZADO_PARA_PUBLICACAO",
  },
  AUTORIZADO_PARA_PUBLICACAO: { PUBLICAR: "PUBLICADO" },
