...
async function s3Get(endpoint, region, bucket, prefix, fileName, accessKey, secretKey) {
...
main().catch((error) => {
  process.stderr.write(error instanceof Error ? error.message : "download failed");
  process.exitCode = 1;
});
